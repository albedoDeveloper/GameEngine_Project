...
struct ImGuiStorage
{
	...
	IMGUI_API void      SetIntUniform(ImGuiID key, int val);
	IMGUI_API bool      GetBool(ImGuiID key, bool default_val = false) const;
	IMGUI_API void      SetBoolUniform(ImGuiID key, bool val);
	IMGUI_API float     GetFloat(ImGuiID key, float default_val = 0.0f) const;
	IMGUI_API void      SetFloatUniform(ImGuiID key, float val);
