...
static void ShowDemoWindowWidgets()
{
	...
	if (ImGui::TreeNode("Plots Widgets"))
	{
		...
		if (animate)
		{
			progress += progress_dir * 0.4f * ImGui::GetIO().Time;
			if (progress >= +1.1f)
			{
...
static void ShowDemoWindowLayout()
{
	...
	if (ImGui::TreeNode("Scrolling"))
	{
		...
		if (ImGui::IsItemActive())
			scroll_x_delta = -ImGui::GetIO().Time * 1000.0f;
		ImGui::SameLine();
...
static void ShowDemoWindowMisc()
{
	...
	if (ImGui::CollapsingHeader("Inputs, Navigation & Focus"))
	{
		...
		if (ImGui::TreeNode("Mouse State"))
		{
			...
			ImGui::Text("Mouse down:");     for (int i = 0; i < IM_ARRAYSIZE(io.MouseDown); i++) if (ImGui::IsMouseDown(i))
			{
			...
			ImGui::Text("Mouse dblclick:"); for (int i = 0; i < IM_ARRAYSIZE(io.MouseDown); i++) if (ImGui::IsMouseDoubleClicked(i))
			{
				ImGui::SameLine(); ImGui::Text("b%d", i);
			}
		...
		{
			ImGui::Text("Keys down:");          for (int i = 0; i < IM_ARRAYSIZE(io.KeysDown); i++) if (ImGui::IsKeyDown(i))
			{
