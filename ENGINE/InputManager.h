...
public:
	...
	bool CheckCursorLock();
		...
		/**
		 * @brief Access current Mouse X position
		 * \return mouse X position
		 */
	int GetMouseXPos() const;

		/**
		 * @brief Access current Mouse Y position
		 *
...
private:
	...
	int mouseY = false;
		...
		/** @brief mouse X absolute position */
	int mouseXAbsolute;

		/** @brief mouse Y absolute position */
	int mouseYAbsolute;
