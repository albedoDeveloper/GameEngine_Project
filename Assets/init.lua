...
LoadSound("OrderFood.wav")
LoadSound("Argue.wav")
LoadSound("Pool.wav")
LoadSound("Drink.wav")
LoadSound("LookForMoney.wav")
LoadSound("Texting.wav")
LoadSound("DanceAggressive.wav")
LoadSound("DanceRelax.wav")
LoadSound("tired.wav")
LoadSound("bored.wav")
LoadSound("depressed.wav")
LoadSound("frustrated.wav")
LoadSound("angry.wav")
LoadSound("tense.wav")
LoadSound("excited.wav")
LoadSound("delighted.wav")
LoadSound("happy.wav")
LoadSound("content.wav")
LoadSound("relaxed.wav")
LoadSound("calm.wav")

LoadSound("gravity_pickup.wav")
LoadSound("gravity_hold.wav")
LoadSound("gravity_throw.wav")
...
GetGameObject("jukebox"):AddCSound()
...
GetGameObject("player"):AddCSound();
