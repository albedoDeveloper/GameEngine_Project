...
GetGameObject("book2"):GetCRigidBody():SetAngularVelocity(6,0,0)
GetGameObject("book2"):GetTransform():SetRelativePosition(0,6,0)

SpawnGameObject("book3")
GetGameObject("book3"):AddCStaticMesh():AssignModel("book")
GetGameObject("book3"):AddCCollider():AddBoxCollider(0,0,0,0,0,0,true,1,true, 31)
GetGameObject("book3"):AddCRigidBody():SetMass(2)
GetGameObject("book3"):GetCRigidBody():SetAngularVelocity(0,6,0)
GetGameObject("book3"):GetTransform():SetRelativePosition(2,6,0)

SpawnGameObject("book4")
GetGameObject("book4"):AddCStaticMesh():AssignModel("book")
GetGameObject("book4"):AddCCollider():AddBoxCollider(0,0,0,0,0,0,true,1,true, 31)
GetGameObject("book4"):AddCRigidBody():SetMass(2)
GetGameObject("book4"):GetCRigidBody():SetAngularVelocity(0,0,6)
GetGameObject("book4"):GetTransform():SetRelativePosition(4,6,0)

SpawnGameObject("book5")
GetGameObject("book5"):AddCStaticMesh():AssignModel("book")
GetGameObject("book5"):AddCCollider():AddBoxCollider(0,0,0,0,0,0,true,1,true, 31)
GetGameObject("book5"):AddCRigidBody():SetMass(2)
GetGameObject("book5"):GetCRigidBody():SetAngularVelocity(6,0,0)
GetGameObject("book5"):GetTransform():SetRelativePosition(0,8,0)
GetGameObject("book5"):GetTransform():RotateLocalY(90)

SpawnGameObject("book6")
GetGameObject("book6"):AddCStaticMesh():AssignModel("book")
GetGameObject("book6"):AddCCollider():AddBoxCollider(0,0,0,0,0,0,true,1,true, 31)
GetGameObject("book6"):AddCRigidBody():SetMass(2)
GetGameObject("book6"):GetCRigidBody():SetAngularVelocity(0,6,0)
GetGameObject("book6"):GetTransform():SetRelativePosition(2,8,0)
GetGameObject("book6"):GetTransform():RotateLocalY(90)

SpawnGameObject("book7")
GetGameObject("book7"):AddCStaticMesh():AssignModel("book")
GetGameObject("book7"):AddCCollider():AddBoxCollider(0,0,0,0,0,0,true,1,true, 31)
GetGameObject("book7"):AddCRigidBody():SetMass(2)
GetGameObject("book7"):GetCRigidBody():SetAngularVelocity(0,0,6)
GetGameObject("book7"):GetTransform():SetRelativePosition(4,8,0)
GetGameObject("book7"):GetTransform():RotateLocalY(90)


SpawnGameObject("book8")
GetGameObject("book8"):AddCStaticMesh():AssignModel("book")
GetGameObject("book8"):AddCCollider():AddBoxCollider(0,0,0,0,0,0,true,1,true, 31)
GetGameObject("book8"):AddCRigidBody():SetMass(2)
GetGameObject("book8"):GetCRigidBody():SetAngularVelocity(6,0,0)
GetGameObject("book8"):GetTransform():SetRelativePosition(0,10,0)
GetGameObject("book8"):GetTransform():RotateLocalZ(90)

SpawnGameObject("book9")
GetGameObject("book9"):AddCStaticMesh():AssignModel("book")
GetGameObject("book9"):AddCCollider():AddBoxCollider(0,0,0,0,0,0,true,1,true, 31)
GetGameObject("book9"):AddCRigidBody():SetMass(2)
GetGameObject("book9"):GetCRigidBody():SetAngularVelocity(0,6,0)
GetGameObject("book9"):GetTransform():SetRelativePosition(2,10,0)
GetGameObject("book9"):GetTransform():RotateLocalZ(90)

SpawnGameObject("book10")
GetGameObject("book10"):AddCStaticMesh():AssignModel("book")
GetGameObject("book10"):AddCCollider():AddBoxCollider(0,0,0,0,0,0,true,1,true, 31)
GetGameObject("book10"):AddCRigidBody():SetMass(2)
GetGameObject("book10"):GetCRigidBody():SetAngularVelocity(0,0,6)
GetGameObject("book10"):GetTransform():SetRelativePosition(4,10,0)
GetGameObject("book10"):GetTransform():RotateLocalZ(90)
