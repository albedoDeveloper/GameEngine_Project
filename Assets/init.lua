...
GetGameObject("goblin1"):GetTransform():SetPosition(-0.5,2.0,-1)
...
SpawnGameObject("goblin3")
GetGameObject("goblin3"):AddCStaticMesh():AssignModel("goblin")
GetGameObject("goblin3"):AddCScript():AssignScript("rotate")
GetGameObject("goblin3"):GetTransform():SetPosition(1.5,2.0,-1)
--GetGameObject("goblin3"):AddCCollider():AddBoxCollider(0,0,0,0,0,0,true,1)
GetGameObject("goblin3"):AddCCollider():AddConcaveCollider(1)
GetGameObject("goblin3"):GetCCollider():CollideWith(1)
...
GetGameObject("chair3"):GetTransform():SetPosition(-4.83,0.16,-3.12)
...
GetGameObject("chair4"):GetTransform():SetPosition(-5.66,0.16,-3.12)
